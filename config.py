...
eventlog_user = "tg_bot_raw_user"
eventlog_password = "%9d[Z8c=J}Zc"
eventlog_host = "127.0.0.1"
eventlog_port = "5432"

client = pygsheets.authorize(service_account_file='D:\downloads\dark-pipe-338808-d5b8d22ab578.json')
